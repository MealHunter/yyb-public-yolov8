...
namespace AVSAnalyzer {
    ...
    bool AvPushStream::connect() {
        ...
        int bit_rate = 2048000;                            //------------------------2048000/4096000/8192000
    ...
    //        mDstVimVideoCodecCtxdeoCodecCtx->bit_rate = bit_rate;
        ...
        mVideoCodecCtx->gop_size = 10;                          //--------------------------增大GOP，减少关键帧频率5/10
        ...
        if (mVideoCodecCtx->codec_id == AV_CODEC_ID_H264) {
            ...
            av_dict_set(&video_codec_options, "preset", "ultrafast", 0);      //--------------------编码器预设可以改为如 medium 或 slow现在是superfast/ultrafast
