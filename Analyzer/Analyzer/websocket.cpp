...
namespace AVSAnalyzer {
    ...
    // 处理WebSocket帧
    void handle_websocket_frame(SOCKET client_socket, const std::vector<uint8_t>& frame, int count) {
        // 解码有效载荷
        ...
        // 准备响应帧
        std::string response_message = "Server Response: " + count;
    ...
    void main(int count) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                handle_websocket_frame(client_socket, frame, count);
            }
